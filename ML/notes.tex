...
\begin{verbatim}
  ...
  \begin{enumerate}
  \item guess - get the most frequent answer
  \item base case: labels are umbiguous, no more features.
  \item else for all features, compute the score (training
...
-b\}$. Bias is always $-b$, as $b\ra -\infty$ , nothing can be
